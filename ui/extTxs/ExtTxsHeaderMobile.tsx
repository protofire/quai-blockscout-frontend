...
import { SORT_OPTIONS } from './useExtTxsSort';
...
const ExtTxsHeaderMobile = ({ filterComponent, sorting, setSorting, paginationProps, className, showPagination = true, linkSlot }: Props) => {
  return (
...
export default chakra(ExtTxsHeaderMobile);
