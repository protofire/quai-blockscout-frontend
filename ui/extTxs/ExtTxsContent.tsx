...
import type { ExternalTransaction, TransactionsSortingField, TransactionsSortingValue } from 'types/api/transaction';
...
import TxsHeaderMobile from './ExtTxsHeaderMobile';
import TxsList from './ExtTxsList';
import TxsTable from './ExtTxsTable';
