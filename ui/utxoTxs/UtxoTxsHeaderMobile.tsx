...
import { SORT_OPTIONS } from './useUtxoTxsSort';
...
const UtxoTxsHeaderMobile = ({ filterComponent, sorting, setSorting, paginationProps, className, showPagination = true, linkSlot }: Props) => {
  return (
...
export default chakra(UtxoTxsHeaderMobile);
