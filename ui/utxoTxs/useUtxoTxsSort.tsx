...
import type { TransactionsSortingValue, UtxoTxsResponse } from 'types/api/transaction';

import type { ResourceError } from 'lib/api/resources';
import * as cookies from 'lib/cookies';
import type { Option } from 'ui/shared/sort/Sort';

import sortTxs from './sortUtxoTxs';
...
type HookResult = UseQueryResult<UtxoTxsResponse, ResourceError<unknown>> & {
  sorting: SortingValue;
  setSortByValue: (value: SortingValue) => void;
}

export default function useUtxoTxsSort(
  queryResult: UseQueryResult<UtxoTxsResponse, ResourceError<unknown>>,
): HookResult {
