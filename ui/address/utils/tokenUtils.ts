...
const TOKEN_GROUPS_ORDER: Array<TokenType> = [ 'QRC-20', 'QRC-721', 'QRC-1155' ];
...
export const sortingFns = {
  'QRC-20': sortErc20Tokens,
  'QRC-721': sortErc721Tokens,
  'QRC-1155': sortErc1155Tokens,
};
