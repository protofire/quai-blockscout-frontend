...
const NOTIFICATIONS = [ 'native', 'QRC-20', 'QRC-721' ] as const;
...
'notification_settings.QRC-20.outcoming' |
'notification_settings.QRC-20.incoming' |
'notification_settings.QRC-721.outcoming' |
'notification_settings.QRC-721.incoming';
